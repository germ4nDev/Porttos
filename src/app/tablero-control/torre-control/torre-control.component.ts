...
// //     Patrón: PORTTOS Orchestrator Component - Limpieza Absoluta de Pestañas
// // */
...
// /*
//     Author: German Valencia
//     Patrón: PORTTOS Orchestrator Component - Limpieza Absoluta de Pestañas + Virtual Gate
// */
// import { Component, OnInit, OnDestroy, ChangeDetectorRef } from '@angular/core';
// import { CommonModule } from '@angular/common';
// import { Router } from '@angular/router';
...
// import { WidgetsService } from 'src/app/theme/shared/service/tablero-control/widgets.service';
// import { MaritimoService } from 'src/app/theme/shared/service/tablero-control/maritimo.service';
// import { VirtualGateService } from 'src/app/theme/shared/service/tablero-control/virtual-gate.service'; // 👈 Nuevo servicio inyectado
// import { LocalStorageService } from 'src/app/theme/shared/service';
...
//         private _torreService: DashboardService,
//         private _maritimoService: MaritimoService,
//         private _virtualGateService: VirtualGateService, // 👈 Inyectado en el constructor
//         private _filtroService: FiltroTableroService,
//         private _widgetsService: WidgetsService,
//         private _localStoragoService: LocalStorageService,
//         private _layoutService: LayoutService,
...
//                 if (this.pestanaActiva.includes('MARITIMO')) {
//                     this.sincronizarTorreMaritima(puertoStr);
//                 } else if (this.pestanaActiva.includes('VIRTUAL_GATE')) { // 👈 Regla para el Gate
...
//     // 👈 NUEVO MÉTODO PARA EL VIRTUAL GATE
...
//     //         next: (res: any) => {
//     //             // Validamos res.ok porque así lo definimos en el backend de Node.js
//     //             if (res && res.ok && res.data) {
//     //                 // Repartimos la data global a todos los widgets de la pestaña
//     //                 this.dashboard = this.dashboard.map(widget => {
//     //                     return {
//     //                         ...widget,
//     //                         data: {
//     //                             ...widget.data,
//     //                             // Mandamos el resumen para los KPIs y las citas para la Tabla
...
//     // }
//     sincronizarVirtualGate(puerto: string) {
//         // 1. Corrección de seguridad: Apagar el loader si no hay widgets listos
//         if (!this.dashboard || this.dashboard.length === 0) {
//             console.warn('⚠️ Layout vacío. El catálogo de widgets (lsWidgets) podría estar desactualizado en caché.');
//             this.cargando = false;
//             this.isLoading = false;
//             this.cdr.detectChanges();
//             return;
...
//         this._virtualGateService.obtenerColaGate().subscribe({
//             next: (res: any) => {
//                 // 2. Flexibilizamos la validación y procesamos la data
//                 if (res && res.data) {
//                     this.dashboard = this.dashboard.map(widget => {

//                         // Fusionamos la data existente con lo que llega de Node.js
//                         let widgetData = {
//                             ...widget.data,
//                             resumen: res.data.resumen,
//                             citas: res.data.citas
...
//                             switch (widget.type) {
//                                 case 'KPI_GATE_OP':
//                                     widgetData = { titulo: 'CAMIONES EN PUERTO', valor: res.data.resumen.totalCamiones || 0, subtitulo: 'ZONA URBANA BUENAVENTURA', color: '#4dabf7' };
//                                     break;
//                                 case 'KPI_GATE_CONT':
//                                     widgetData = { titulo: 'CONTENEDORES DÍA', valor: '2.847', subtitulo: 'FCL 1.900 · LCL 500 · Reefer 447', color: '#22b8cf' };
//                                     break;
//                                 case 'KPI_GATE_GRANEL':
//                                     widgetData = { titulo: 'GRANEL - TONS DÍA', valor: '38.4K', subtitulo: 'Agrícola 20K · Mineral 18.4K', color: '#fd7e14' };
//                                     break;
//                                 case 'KPI_GATE_SUELTA':
//                                     widgetData = { titulo: 'CARGA SUELTA - TM', valor: '4.820', subtitulo: 'Break-bulk 3.000 · Paletizada 1.820', color: '#fcc419' };
//                                     break;
//                                 case 'KPI_GATE_RORO':
//                                     widgetData = { titulo: 'VEHÍCULOS RO-RO', valor: '1.142', subtitulo: 'Imp 800 · Exp 342 · PDI 85%', color: '#20c997' };
//                                     break;
//                                 case 'KPI_GATE_BODEGAS':
//                                     widgetData = { titulo: 'SATURACIÓN BODEGAS', valor: '72%', subtitulo: '5 bodegas · 1 crítica · ruteo activo', color: '#cc5de8' };
//                                     break;
//                                 case 'KPI_SUB_CONT':
//                                     widgetData = { titulo: 'SUB - CONTENEDORES', valor: 42, subtitulo: 'Retiros y devoluciones', color: '#868e96' };
//                                     break;
//                                 case 'KPI_SUB_GRANEL':
//                                     widgetData = { titulo: 'SUB - GRANEL', valor: 28, subtitulo: 'Flujo hacia silos', color: '#868e96' };
//                                     break;
//                                 case 'KPI_SUB_SUELTA':
//                                     widgetData = { titulo: 'SUB - CARGA SUELTA', valor: 11, subtitulo: 'Operación en bodega', color: '#868e96' };
//                                     break;
//                                 case 'KPI_SUB_NINERAS':
//                                     widgetData = { titulo: 'SUB - NIÑERAS', valor: 6, subtitulo: 'Trasiego a patios', color: '#868e96' };
//                                     break;
//                             }
//                         }
...
//                     });
//                 } else {
//                     console.warn('⚠️ La API respondió, pero no trajo el nodo "data":', res);
//                 }

//                 // 3. Garantía absoluta de que el loader se apaga y se renderiza
//                 this.cargando = false;
//                 this.isLoading = false;
//                 if (this.options.api && this.options.api.optionsChanged) {
//                     this.options.api.optionsChanged();
...
//         if (this.options.api && this.options.api.optionsChanged) this.options.api.optionsChanged();
//         if (this.pestanaActiva.includes('MARITIMO')) this.sincronizarTorreMaritima(this.puertoSeleccionado);
//         if (this.pestanaActiva.includes('VIRTUAL_GATE')) this.sincronizarVirtualGate(this.puertoSeleccionado); // 👈 Regla aplicada también aquí
//         this.hayCambiosSinGuardar = true;
//     }
...
export class TorreControlComponent implements OnInit, OnDestroy {
    ...
    //         else if (esVirtualGate) {
    //             this.dashboard = [...layoutBase].map(item => ({ ...item }));
    //             console.log('************FILTRAR DONDE visible == true', this.dashboard);
    //             if (this.options.api && this.options.api.optionsChanged) this.options.api.optionsChanged();

    //             this.sincronizarVirtualGate(this.puertoSeleccionado);
    //         }
    //         else if (esContenedores) { // 👈 Ramificación para arrancar Contenedores
    //             this.dashboard = [...layoutBase].map(item => ({ ...item }));
    //             if (this.options.api && this.options.api.optionsChanged) this.options.api.optionsChanged();
    ...
    // ==========================================
    // MÉTODOS DE SINCRONIZACIÓN POR MÓDULO
    // ==========================================
    ...
    // 👈 NUEVO MÉTODO PARA CONTENEDORES
