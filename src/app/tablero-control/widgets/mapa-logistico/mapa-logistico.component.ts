...
//                         tipo_faro: item.tipo_faro,
//                         estado_kpi: item.estado_kpi,
//                         color_ui: item.color_ui, // 👈 AQUÍ pasamos el color de la geocerca a MapLibre
//                         total_camiones: item.total_camiones,
//                         camiones_ruta: item.camiones_ruta,
//                         camiones_detenidos: item.camiones_detenidos,
//                         total_naves: item.total_naves,
...
//                         tipo: 'puerto',
//                         color_ui: puerto.color_ui // 👈 AQUÍ inyectamos el color del puerto
//                     }
//                 });
//             }
...
//                                             nombre: muelle.nombre_muelle,
//                                             tipo: 'muelle',
//                                             color_ui: muelle.color_ui // 👈 AQUÍ inyectamos el color del muelle
//                                         }
//                                     };
//                                     muellesFeaturesTerminal.push(muelleFeature);
//                                     features.push(muelleFeature);
...
//                                 tipo: 'terminal',
//                                 autogenerada: !wktTerminal,
//                                 color_ui: terminal.color_ui // 👈 AQUÍ inyectamos el color de la terminal
//                             }
//                         });
//                     }
//                 });
...
//             // --- CAPAS DE EVENTOS, CAMIONES Y MOTONAVES (Se mantienen con su lógica de negocio) ---
//             { id: 'highlight-layer', type: 'line', source: 'highlight-source', paint: { 'line-color': this.isDark ? '#f59e0b' : '#c2410c', 'line-width': 4, 'line-opacity': 0.9, 'line-dasharray': [2, 2] }, layout: { 'line-cap': 'round', 'line-join': 'round' } },
//             { id: 'capa-infra-point', type: 'circle', source: 'infra-source', filter: ['==', '$type', 'Point'], paint: { 'circle-radius': 8, 'circle-stroke-width': 2, 'circle-stroke-color': '#ffffff', 'circle-color': ['match', ['get', 'estado_operativo'], 'libre', '#22c55e', 'ocupado', '#facc15', 'congestionado', '#f59e0b', 'critico', '#dc2626', 'desocupado', '#94a3b8', '#38bdf8'] } },
//             // { id: 'terrestre-clusters', type: 'circle', source: 'terrestre-source', filter: ['has', 'point_count'], paint: { 'circle-color': '#10b981', 'circle-radius': 15, 'circle-stroke-width': 2, 'circle-stroke-color': '#ffffff' } },
//             // { id: 'terrestre-cluster-count', type: 'symbol', source: 'terrestre-source', filter: ['has', 'point_count'], layout: { 'text-field': '{point_count}', 'text-size': 12 }, paint: { 'text-color': '#ffffff' } },
...
//             'icon-size': 0.08, // Ajusta si el ícono original es grande
//             'icon-allow-overlap': true,
//             'text-field': '{point_count}',
//             'text-size': 12,
//             'text-font': ['Open Sans Bold', 'Arial Unicode MS Bold'],
//             'text-allow-overlap': true,
//             'text-offset': [0, 1.2] // Mueve el número un poco hacia abajo del camión para que se lea bien
//         },
//         paint: {
//             'text-color': '#ffffff',
//             'text-halo-color': '#0f172a', // Sombra oscura para que resalte el número
//             'text-halo-width': 2
//         }
//     },
//             // {
...
//                     'icon-size': [
//                         'case',
//                         ['>', ['get', 'velocidad'], 0], 0.0195, // <-- Cambiado de 0.8 a 0.08
//                         0.0195 // <-- Cambiado de 0.6 a 0.05
//                     ],
//                     'icon-allow-overlap': true
//                 }
//             },
...
//                     ],
//                     'icon-size': [
//                         'case', ['>=', ['get', 'nivelSeveridad'], 3], 0.1, 0.1 // <-- Ajustado
//                     ],
//                     'icon-allow-overlap': true
//                 }
//             },
...
//                 layout: {
//                     'icon-image': 'icono-barco',
//                     'icon-size': 0.06, // <-- Ajusta este número (ej. 0.04 a 0.08) hasta que se vea bien
//                     'icon-allow-overlap': true,
...
//                     'text-field': ['get', 'nombre_motonave'],
//                     'text-size': 11,
//                     'text-offset': [0, 2], // <-- Súbele esto de 1.5 a 2 o 2.5 para separarlo del ícono
//                     'text-anchor': 'top'
//                 },
//                 paint: {
//                     'text-color': '#ffffff',
