...
// //         this.maritimoSub = this._mapaSocketService.maritimoData$.subscribe((geoJson: any) => {
// //             // 🛡️ Desempaquetado seguro para Sockets
// //             const dataToSet = (geoJson && geoJson.data && geoJson.data.type === 'FeatureCollection') ? geoJson.data : geoJson;

// //             if (dataToSet && dataToSet.features) {
// //                 console.log(`✅ [SOCKET] ¡Radar actualizado con ${dataToSet.features.length} naves!`);
// //                 this.actualizarFuente('naves-source', dataToSet);
// //             }
// //         });
// //     }
...
// //         //     // 1. Primero conectamos las "antenas" (Suscripciones)
// //         //     this.suscribirseADatos();
// //         //     this.configurarEventosClicks();
// //         //     this.iniciarRadarGeocercas();
// //         //     this.iniciarRadarTiempoReal();

// //         //     // 2. AHORA SÍ pedimos los datos, asegurando que nadie se pierda la respuesta
// //         //     this._mapaService.cargarDatosIniciales();
// //         // });
...
// //                     // CORRECCIÓN: Usamos un setTimeout nativo en lugar de executeRenderTask
// //                     setTimeout(() => {
// //                         this.leerSessionYEnfocar(true);
// //                     }, 50);
// //                 }
...
// //                     // ❌ ELIMINADO: 'text-font' para evitar crasheos silenciosos del canvas
// //                 },
...
// //                 filter: ['!', ['has', 'point_count']],
// //                 paint: {
// //                     'circle-color': '#00E5FF', // Azul neón radar
// //                     'circle-radius': 7,
...
// //                     'text-field': ['get', 'nombre_motonave'],
// //                     'text-size': 11,
// //                     'text-offset': [0, 1.5], // Offset corregido para que no pise el círculo
// //                     'text-anchor': 'top'
// //                 },
// //                 paint: {
// //                     'text-color': '#ffffff',
...
// //         // 🛡️ Desempaquetado seguro de la petición HTTP inicial
...
// //         //     if (dataToSet && dataToSet.features) {
// //         //         console.log(`✅ [HTTP] ¡Detectadas ${dataToSet.features.length} naves en el mapa principal!`);
// //         //         this.actualizarFuente('naves-source', dataToSet);
// //         //     }
// //         // }));
...
// //         //         { id: 'naves-cluster-count', visible: vis['naves'] },
// //         //         { id: 'naves-individual', visible: vis['naves'] },
// //         //         { id: 'naves-nombres', visible: vis['naves'] },
// //         //         { id: 'capa-infra-fill', visible: isInfraVisible },
// //         //         { id: 'capa-infra-line', visible: isInfraVisible },
// //         //         { id: 'capa-infra-point', visible: isInfraVisible },
// //         //         { id: 'puerto-fill', visible: isInfraVisible },
...
// //             // 🌟 CORRECCIÓN: Si la variable no existe (undefined), asumimos que es TRUE por defecto.
// //             const isInfraVisible = vis['infra'] !== false;
// //             const isNavesVisible = vis['naves'] !== false; // <-- Aquí estaba el problema
...
// //                 { id: 'naves-clusters', visible: isNavesVisible },
// //                 { id: 'naves-cluster-count', visible: isNavesVisible },
...
// //                 { id: 'puerto-fill', visible: isInfraVisible },
// //                 { id: 'puerto-line', visible: isInfraVisible },
// //                 { id: 'terrestre-clusters', visible: isTerrestreVisible },
// //                 { id: 'terrestre-cluster-count', visible: isTerrestreVisible },
// //                 { id: 'terrestre-individual', visible: isTerrestreVisible },
// //                 { id: 'clima-layer', visible: isClimaVisible },
// //                 { id: 'viales-clusters', visible: isAccidentesVisible },
// //                 { id: 'viales-cluster-count', visible: isAccidentesVisible },
// //                 { id: 'viales-individual', visible: isAccidentesVisible },
// //                 { id: 'peajes-clusters', visible: isPeajesVisible },
// //                 { id: 'peajes-cluster-count', visible: isPeajesVisible },
...
// //             mapping.forEach(m => {
// //                 if (this.map.getLayer(m.id)) {
// //                     // Ahora sí, si no es explícitamente false, se pinta.
// //                     this.map.setLayoutProperty(m.id, 'visibility', m.visible ? 'visible' : 'none');
// //                 }
// //             });
// //         }));
...
// //                 return `
// //                 <div class="custom-map-popup nave-popup" style="min-width: 250px; font-family: sans-serif;">
// //                     <div class="qplus-popup-header" style="border-bottom: 2px solid #00E5FF; padding-bottom: 8px; margin-bottom: 8px;">
// //                         <h3 style="color:#0056b3; margin:0 0 6px 0; font-size: 15px;">🚢 ${data.nombre_motonave || 'DESCONOCIDA'}</h3>
// //                         <div style="display: flex; gap: 6px; flex-wrap: wrap;">
// //                             <span style="background-color: #334155; color: #fff; padding: 3px 6px; border-radius: 4px; font-size: 10px; font-weight: bold;">MMSI: ${data.mmsi || 'N/A'}</span>
// //                             <span style="background-color: ${badgeColor}; color: ${estadoNave === 'FONDEADAS' ? '#000' : '#fff'}; padding: 3px 6px; border-radius: 4px; font-size: 10px; font-weight: bold;">${estadoNave}</span>
// //                         </div>
...
// //                     <div class="qplus-popup-body" style="font-size: 12px; line-height: 1.5; color: ${this.isDark ? '#e2e8f0' : '#334155'};">
// //                         <b>OMI:</b> ${omi}<br>
...
//     // 🧠 DICCIONARIO MAESTRO PARA FUSIONAR DATOS HTTP Y SOCKET
...
//         //     if (dataToSet && dataToSet.features && dataToSet.features.length > 0) {
//         //         console.log(`📡 [SOCKET] ¡Posiciones actualizadas para ${dataToSet.features.length} naves!`);

//         //         dataToSet.features.forEach((featureSocket: any) => {
...
//         //                 if (naveExistente) {
//         //                     // Si ya venía de la BD, le actualizamos SOLO la geometría (posición en el mapa)
//         //                     // y le fusionamos las nuevas propiedades del socket sin perder las de la BD
//         //                     featureSocket.properties = { ...naveExistente.properties, ...featureSocket.properties };
//         //                 }
//         //                 // Guardamos/Actualizamos en el diccionario
//         //                 this.navesActuales.set(idUnico, featureSocket);
//         //             }
//         //         });
//         //         // Pintamos el resultado combinado
//         //         this.renderizarNavesFusionadas();
//         //     }
//         // });
//         // Nos conectamos a la sala si lo requiere tu arquitectura
//         if (this._mapaSocketService && typeof this._mapaSocketService.conectarSalaMaritima === 'function') {
//             this._mapaSocketService.conectarSalaMaritima();
//         }

//         // Escuchamos el evento único 'radar-actualizado' emitido desde el backend
//         this.maritimoSub = this._socketService.listen('radar-actualizado').subscribe((featureSocket: any) => {
//             if (featureSocket && featureSocket.geometry && featureSocket.properties) {
...
//                     if (naveExistente) {
//                         this.toastr.show('nave detectada');
//                         // Si la nave ya estaba registrada (ej. cargada por HTTP),
//                         // fusionamos sus propiedades para no perder la agencia, el ETA o el estado,
//                         // pero actualizamos sus coordenadas de geometría con el nuevo tick del socket.
//                         featureSocket.properties = { ...naveExistente.properties, ...featureSocket.properties };
//                     }

//                     // Actualizamos o insertamos el barco en el diccionario maestro
//                     this.navesActuales.set(idUnico, featureSocket);

//                     // Repintamos instantáneamente el mapa con la posición más reciente
//                     this.renderizarNavesFusionadas();
//                 }
//             }
//         });
...
//         // 🟢 1. Carga inicial desde la Base de Datos (HTTP)
//         this.subs.add(this._mapaService.naves$.subscribe((data: any) => {
//             const dataToSet = (data && data.data && data.data.type === 'FeatureCollection') ? data.data : data;
//             if (dataToSet && dataToSet.features) {
...
export class MapaLogisticoComponent implements AfterViewInit, OnInit, OnDestroy, IWidget {
    ...
    // 🧠 DICCIONARIO MAESTRO PARA FUSIONAR DATOS HTTP Y SOCKET
    private navesActuales = new Map<string, any>();
    // ⏱️ MECANISMO ANTI-SPAM PARA LOS TOASTS DE RADAR
    ...
    private iniciarCapaMaritima(): void {
        ...
        //             // 🛡️ LÓGICA DE TOAST CON ANTI-SPAM
        //             const now = Date.now();
        //             const lastTime = this.lastNotificationTimes.get(idUnico) || 0;

        //             // Mostramos el Toast solo si han pasado al menos 30 segundos desde el último aviso de esta nave
        //             if (now - lastTime > 30000) {
        //                 this.toastr.info(
        //                     `Posición actualizada en el radar`,
        //                     `🚢 ${nombreNave}`,
        //                     {
        //                         timeOut: 3000,
        //                         positionClass: 'toast-bottom-right',
        ...
        //                     }
        //                 );
        //                 // Registramos el tiempo de esta notificación
        //                 this.lastNotificationTimes.set(idUnico, now);
        //             }
        //         }
        //     }
        // });
        this.maritimoSub = this._socketService.listen('radar-actualizado').subscribe((featureSocket: any) => {
            if (featureSocket && featureSocket.geometry) {
                ...
                // 1. Crear el punto de Turf con la coordenada de la nave
                const puntoNave = turf.point(featureSocket.geometry.coordinates);
                let faroDetectado = null;

                // 2. Evaluar intersección con los faros activos
                for (const faro of this.farosActivos) {
                    if (faro.geocerca_geo && faro.geocerca_geo.features.length > 0) {
                        ...
                        // Magia espacial de Turf.js
                        if (turf.booleanPointInPolygon(puntoNave, poligonoFaro)) {
                            faroDetectado = faro;
                            break; // Encontramos el faro, detenemos el loop
                        }
                    }
                }

                // 3. Lógica de Alertas y Geofencing
                ...
                // Si hay un faro detectado, es diferente al anterior, Y tiene alertas activadas
                ...
                // 4. Actualizamos el estado de la nave para el próximo ciclo
                featureSocket.properties = {
                    ...(naveExistente ? naveExistente.properties : {}),
                    ...featureSocket.properties,
                    faro_actual_id: faroDetectadoId // Guardamos el ID del faro actual
                };

                this.navesActuales.set(idUnico, featureSocket);
                this.renderizarNavesFusionadas(); // O como se llame tu método para repintar naves
            }
        });
    }
    ...
    private renderizarFarosMapa(): void {
        // Solo continuamos si el mapa existe y su estilo base ya cargó
        if (!this.map || !this.map.isStyleLoaded()) return;
        ...
        // Simplemente inyectamos la data en la fuente que ya creamos en inicializarCapas()
    ...
    private inicializarMapa(): void {
        ...
        this.map.on('style.load', () => {
            const iconosLogistica = [
                ...
                { id: 'alerta-accidente', url: '/assets/icons/accidente.png' },
                { id: 'alerta-congestion', url: '/assets/icons/congestion.png' },
    ...
    private inicializarCapas(): void {
        ...
        // 2. [CORRECCIÓN] Agregamos explícitamente el source de los faros para evitar el error 'not found'
        if (!this.map.getSource('source-faros')) {
            this.map.addSource('source-faros', { type: 'geojson', data: emptyData });
        }

        // 3. Fuentes externas estáticas
        if (!this.map.getSource('vias-source')) {
            this.map.addSource('vias-source', { type: 'geojson', data: '/assets/data/Red_Vial_20260626.geojson' });
        }

        // 4. Capas directas (fuera del arreglo)
        this.map.addLayer({
            id: 'debug-terminales-fill',
            type: 'fill',
            source: 'infra-source',
        ...
        // 5. Arreglo de renderizado de capas (El orden importa para la superposición visual / Z-Index)
        const layers = [
            // --- FONDOS Y GEOMETRÍAS BASE (Se dibujan abajo) ---
            { id: 'capa-infra-fill', type: 'fill', source: 'infra-source', filter: ['all', ['==', '$type', 'Polygon'], ['!=', 'tipo', 'puerto']], paint: { 'fill-color': this._getMatchConfig('fill'), 'fill-opacity': 0.7 } },
            { id: 'capa-infra-line', type: 'line', source: 'infra-source', filter: ['all', ['==', '$type', 'Polygon'], ['!=', 'tipo', 'puerto']], paint: { 'line-color': this._getMatchConfig('line'), 'line-width': 1.5 } },
            { id: 'puerto-fill', type: 'fill', source: 'infra-source', filter: ['all', ['==', '$type', 'Polygon'], ['==', 'tipo', 'puerto']], paint: { 'fill-color': !this.isDark ? '#60a5fa' : '#3b82f6', 'fill-opacity': 0.15 } },
            { id: 'puerto-line', type: 'line', source: 'infra-source', filter: ['all', ['==', '$type', 'Polygon'], ['==', 'tipo', 'puerto']], paint: { 'line-color': !this.isDark ? '#699dd8' : '#567cf7', 'line-width': 2.5, 'line-dasharray': [4, 2] } },
            ...
            // --- GEOCERCAS Y FAROS (Polígonos translúcidos debajo de los marcadores) ---
            { id: 'geocercas-layer', type: 'fill', source: 'geocercas-peajes-source', paint: { 'fill-color': '#eab308', 'fill-opacity': 0.15 } },
            { id: 'geocercas-line-layer', type: 'line', source: 'geocercas-peajes-source', paint: { 'line-color': '#ca8a04', 'line-width': 1, 'line-dasharray': [4, 4] } },
            { id: 'geocerca-fill-layer', type: 'fill', source: 'geocercas-kpi-source', paint: { 'fill-color': ['match', ['get', 'estado_kpi'], 'ROJO', '#dc2626', 'AMARILLO', '#facc15', 'VERDE', '#22c55e', '#94a3b8'], 'fill-opacity': 0.3 } },
            { id: 'geocerca-line-layer', type: 'line', source: 'geocercas-kpi-source', paint: { 'line-color': '#3b82f6', 'line-width': 2, 'line-dasharray': [4, 2] } },
            // [CORRECCIÓN] Los faros se renderizan aquí para no tapar los barcos/camiones
            {
                id: 'layer-faros-fill',
                type: 'fill',
                source: 'source-faros',
                paint: {
                    'fill-color': ['get', 'color_ui'],
                    'fill-opacity': 0.25
                }
            },
            {
                ...
                source: 'source-faros',
                paint: {
                    'line-color': ['get', 'color_ui'],
                    'line-width': 2,
                    'line-dasharray': [3, 3]
                }
            },

            // --- MARCADORES, PUNTOS Y VECTORES DE DATOS (Se dibujan arriba) ---
            { id: 'highlight-layer', type: 'line', source: 'highlight-source', paint: { 'line-color': this.isDark ? '#f59e0b' : '#c2410c', 'line-width': 4, 'line-opacity': 0.9, 'line-dasharray': [2, 2] }, layout: { 'line-cap': 'round', 'line-join': 'round' } },
            { id: 'capa-infra-point', type: 'circle', source: 'infra-source', filter: ['==', '$type', 'Point'], paint: { 'circle-radius': 8, 'circle-stroke-width': 2, 'circle-stroke-color': '#ffffff', 'circle-color': ['match', ['get', 'estado_operativo'], 'libre', '#22c55e', 'ocupado', '#facc15', 'congestionado', '#f59e0b', 'critico', '#dc2626', 'desocupado', '#94a3b8', '#38bdf8'] } },
        ...
        // 7. Carga inicial de datos desde el servicio
        this._mapaService.cargarDatosIniciales();
    }
        ...
        switch (layerId) {
            ...
            case 'naves-individual':
                ...
                <div class="custom-map-popup nave-popup" style="min-width: 260px; font-family: sans-serif;">
                    ...
                    <div class="qplus-popup-header" style="border-bottom: 2px solid #00E5FF; padding-bottom: 8px; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: flex-start;">

                        <!-- Columna Izquierda: Nombre de la Nave -->
